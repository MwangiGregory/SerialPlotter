...
void SerialApplication::Setup()
{
    ports = DetectSerialPorts();
}

void SerialApplication::Destroy()
{
    serial.closeDevice();
}

void SerialApplication::Update()
{
    ports = DetectSerialPorts();
...
void SerialApplication::UpdateSerialMonitor()
{
    // Serial Monitor text
...
void SerialApplication::SerialPlotter()
{
...
std::vector<std::string> SerialApplication::DetectSerialPorts()
{
    serialib tester;
    int baud = 115200;
    char port_name[64];
